...
# happened, then prepend the block to the TOP of HANDOFF.md (newest first).
#
set -euo pipefail
...
**Decided (see BIBLE §4):** _(fill in — decisions go in the file, not just chat)_
...
**Continuity warnings:** _(fill in — invariants that must not break)_
